...
**Arguments:** `$ARGUMENTS` — the project name/description to locate, optionally followed by `--note` (writes the rendered orientation into the confirmed project's own `_harness/`, when it has one — see step 4).
