...
- [ADR 0023 — gate the integrated tree](0023-gate-on-integrated-tree) — the decision behind the gate-on-merged-tree + hard-reset-rollback rows in [Integrating a worker](#integrating-a-worker).
