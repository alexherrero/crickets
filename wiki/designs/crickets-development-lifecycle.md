...
- **Re-audit triggers:** split `/retire` out of `/deprecate`; flip per-task worktrees + the orchestration split + the loop/goal drivers to as-built as they ship.
