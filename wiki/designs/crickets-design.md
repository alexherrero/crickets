...
- **Voice:** `personal/_always-load/voice-kernel.md` (the always-on essence + tells) · `projects/_global/wiki-style/docs-prose-style.md` (the on-demand design/wiki prose refinement, demoted from always-load 2026-07-05 per PLAN-r3-voice-mechanism — see [wiki](crickets-wiki.md)'s 2026-07-05 amendment) · `style_resolver.py` (the base⊕overlay seam, built for wiki)
