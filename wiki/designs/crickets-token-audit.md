...
- **couples to the agentm memory engine** — the auto-on-stop capture writes a `session-cost` memory record (**delivered** 2026-07-07); the dreaming-pass review remains designed, unchanged in its own gating on the dreaming pass.
