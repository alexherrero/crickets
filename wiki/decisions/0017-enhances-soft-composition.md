...
- [ADR 0013](crickets-v3-native-plugins) — bundles are native plugins generated from one SoT (the `requires:`/`standalone:` hard-dep model `enhances:` extends).
