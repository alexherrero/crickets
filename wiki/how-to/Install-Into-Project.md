...
crickets ships as **native host plugins** generated from one source ([ADR 0013](crickets-build-system)); the old `install.sh` dispatcher is gone ([ADR 0014](crickets-build-system)). There are six:
