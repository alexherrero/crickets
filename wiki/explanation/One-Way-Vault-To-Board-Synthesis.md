...
> [!NOTE]
> These calls are recorded formally in [ADR 0025 — one-way vault→GitHub-Project board synthesis](0025-board-sync-vault-to-project), with the "why not the alternative" reasoning per call and the re-audit triggers. This section is the narrative; the ADR is the decision of record.
...
- [ADR 0025](0025-board-sync-vault-to-project) — the decision of record for the locked design calls.
