...
V4 carries the memory line forward; non-V4 backlog stays on the slimmed ROADMAP. The full V4 design space lives in the [AgentMemory evolution HLD](agent-memory-evolution) (shipped alongside this retrospective) and the new `.harness/ROADMAP-AgentMemoryV4.md`. Headlines:
